      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
        {images.map((img, idx) => (
          <button
            ...
            className={`group relative overflow-hidden bg-noir-700 ${idx === 0 ? "col-span-2 row-span-2 aspect-square md:aspect-auto md:h-full" : "aspect-[4/5]"}`}
          ...
          >
            ...
            />
            <span className="absolute inset-0 bg-noir/10 group-hover:bg-transparent transition-colors duration-500" />
