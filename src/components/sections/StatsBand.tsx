    ...
    <section className="relative py-24 md:py-32 border-y border-pearl bg-cream">
      <div className="container-luxe">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 md:gap-y-0">
          {stats.map((s, i) => (
            <Reveal key={s.label} delay={i * 0.1} className="text-center md:border-l md:border-pearl md:first:border-l-0 md:px-8">
              <p className="font-serif text-6xl md:text-7xl lg:text-8xl text-noir leading-none">
